    ...
    */
    ...
    return (
        <>
            ...
            <div className="relative flex h-auto min-h-screen w-full flex-col group/design-root overflow-x-hidden">
                ...
                <div className="p-4 grid grid-cols-[30%_1fr] gap-x-6">
                    ...
                    <div
                        ...
                        <p className="text-slate-800 dark:text-white text-sm font-normal leading-normal">0</p>
                    </div>
                    <div
            ...
            {isOpen && (
                <div className="fixed inset-0 flex items-center justify-center bg-black/30 backdrop-blur-sm z-50 overflow-y-auto">
